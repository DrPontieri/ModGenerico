...
namespace FrontEndGenerico.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DataCadastro,Id")] Pessoa pessoa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DataCadastro,Id")] Pessoa pessoa)
        {
            if (id != pessoa.Id)
            {
                return NotFound();
